...
const FAQS = [
  {
    q: "Are all Corona Properties plots RAJUK-approved?",
    a: "Yes, every single plot we sell comes with full RAJUK approval and clear legal documentation. We never list plots without verified titles and proper approvals — that's our core promise.",
  },
  {
