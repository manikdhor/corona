...
export default function TopBar() {
  return (
    <div className="hidden lg:block bg-navy-950 border-b border-white/[0.06]">
      <div className="container-luxury flex h-11 items-center justify-between text-[11px] tracking-wider">
        <div className="flex items-center gap-7">
          ...
          <span className="flex items-center gap-2 text-cream/50">
            <Clock className="h-3 w-3 text-gold-500/70" />
            <span>Sat – Thu: 9AM – 6PM</span>
          </span>
        </div>
        <div className="flex items-center gap-6">
          <span className="flex items-center gap-2 text-cream/50">
            <MapPin className="h-3 w-3 text-gold-500/70" />
            <span>Gulshan 01, Dhaka</span>
          </span>
